...
const HomeStats = forwardRef((props, ref) => {
  ...
  return (
    <div className="stats-container" ref={ref}>
      <div className="stats-content" ref={containerRef}>
        {/* Left: Stats */}
        <div className="stats-left">
          <div className="stat-item">
            <p>Years of Experience</p>
            <h2>{triggerAnimation ? <AnimatedNumber key="1" value={5} /> : 0}+</h2>
          </div>
          <div className="stat-item">
            <p>Projects Delivered</p>
            <h2>{triggerAnimation ? <AnimatedNumber key="2" value={100} /> : 0}+</h2>
          </div>
          <div className="stat-item">
            <p>Happy Clients</p>
